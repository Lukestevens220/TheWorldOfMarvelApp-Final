...
//
//    public StoriesAdapter(Context context, List<Hero.Data.Result> comicList){
...
//        holder.digitalId.setText(comic.getId().toString());
...
//            this.digitalId = (TextView) itemView.findViewById(R.id.digitalId);
